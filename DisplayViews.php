...
?>
<center>
      <img src="/php/counter/person.png" width="16" height="16" border="0" /> <?php echo $online; ?>  Online 
	  <br>
	  <img src="/php/counter/views.gif" width="16" height="16" border="0" /> <?php echo $all; ?>  Views
</center>